...
public class SystemOS implements Runnable {
    ...
    public void initSimulationQueueSimpler() {
        ...
        temp = new MemoryInstruction(MemoryOperationType.LOAD, r.nextInt(tempSize), (byte) -1, 4); // Load from logical
                                                                                                   // address 5, 4 clock
                                                                                                   // cycles
        ...
        temp = new MemoryInstruction(MemoryOperationType.STORE, r.nextInt(tempSize), (byte) 38, 3); // Store in logical
                                                                                                    // address 10, valir
                                                                                                    // 38, 3 clock
                                                                                                    // cycles
        p.addInstruction(temp);
        ...
        // temp = new IOInstruction(3);
        temp = new MemoryInstruction(MemoryOperationType.STORE, r.nextInt(tempSize), (byte) 42, 4); // Store in logical
                                                                                                    // address 10, valir
                                                                                                    // 38, 3 clock
                                                                                                    // cycles
        p.addInstruction(temp);
